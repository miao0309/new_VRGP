...
namespace UniVRM10
{
    public static class ExpressionExtensions
    {
        ...
        public static UniVRM10.MaterialColorBinding? Build10(this MaterialColorBind bind, IReadOnlyList<VRMShaders_new.MaterialFactory.MaterialLoadInfo> materials)
        {
        ...
        public static UniVRM10.MaterialUVBinding? Build10(this TextureTransformBind bind, IReadOnlyList<VRMShaders_new.MaterialFactory.MaterialLoadInfo> materials)
        {
            var material = materials[bind.Material.Value].Asset;
