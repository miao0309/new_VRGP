...
namespace UniVRM10
{
    ...
    public class Vrm10Importer : UniGLTF.ImporterContext
    {
        ...
        public async Task<Texture2D> LoadVrmThumbnailAsync(IAwaitCaller awaitCaller = null)
        {
            ...
            if (Vrm10TextureDescriptorGenerator.TryGetMetaThumbnailTextureImportParam(Data, m_vrm.VrmExtension, out (SubAssetKey, VRMShaders_new.TextureDescriptor Param) kv))
            {
        ...
        public static Renderer CreateRenderer(VrmLib.Node node, GameObject go, ModelMap map,
            IReadOnlyList<VRMShaders_new.MaterialFactory.MaterialLoadInfo> materialLoadInfos)
        {
